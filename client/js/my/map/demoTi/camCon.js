/**
 * Created by unagii on 20.03.2016.
 */
...
pc.script.attribute('targetModelName', 'string', 'ran');

pc.script.create("camCon", function (context) {
    ...
    Camera.prototype = {
        ...
        setBestCameraPositionForModel: function() {
            ...
            for (i = 0; i < models.length; i++) {
                if (models[i]._entity && models[i]._entity.name === this.targetModelName) {
        ...
        onMouseMove: function (event) {
            ...
            } else if (event.buttons[pc.input.MOUSEBUTTON_CENTER] || event.buttons[pc.input.MOUSEBUTTON_RIGHT]) {
