...
function Conf() {
    ...
    var eType = [];
    eType[0] = { name:"t1", keyWords:["structure"]  ,color:0x00ff00,textureAtlas:"../img/testTexture.json",texture:"Angel.ico",className:'my.mapControll.entity.Entity'};
    eType[1] = { name:"t2",keyWords:["structure"] ,color:0x00ff00,textureAtlas:"../img/testTexture.json",texture:"Angel.ico",className:'my.mapControll.entity.Entity'};
    eType[2] = { name:"player", keyWords:["unit"],color:0x00ff00,textureAtlas:"../img/testTexture.json",texture:"Angel.ico",className:'my.mapControll.entity.Unit'};
    eType[3] = { name:"mob", keyWords:["unit"],color:0xff0000,textureAtlas:"../img/testTexture.json",texture:"Angel.ico",className:'my.mapControll.entity.Unit'};
    eType[4] = {name:"bullet", keyWords:["bullet"],color:0xff0000,textureAtlas:"../img/testTexture.json",texture:"Devil.ico",className:'my.mapControll.entity.Bullet'};
    this.eType=eType
